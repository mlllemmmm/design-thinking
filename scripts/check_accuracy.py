...
CSV_PATH = os.path.join(BACKEND_DIR, "data", "heart.csv")        # Change to your dataset
MODEL_PATH = os.path.join(BACKEND_DIR, "models", "heart_model.pkl")  # Path to trained model
